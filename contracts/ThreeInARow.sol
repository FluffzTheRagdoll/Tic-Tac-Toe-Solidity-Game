...
contract ThreeInARow {
    ...
    uint256 public gameCost = 1 ether;
    ...
    constructor(address _addrGameManager, address payable _player1) payable {
        ...
        require(msg.value == gameCost, "The amount of Ether you sent is not enough.");
        player1 = _player1;
    }

    function joinGame() public payable {
        //player2 joins the game here
        ...
        gameVaildUntil = block.timestamp + timeToReact;
    ...
    function setStone(uint8 x, uint8 y) public {
        ...
        require(gameVaildUntil >= block.timestamp);
        moveCounter++;
